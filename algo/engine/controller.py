    ...
    def run(self):
        ...
        while True:
            ...
            if self.strategy:
                ...
                try:    
                    ...
                    self.tv_chart.maybe_export(self.strategy.candles_df.iloc[:data_state_manager.current_index], trade_journal.trades)
        ...
        if self.tv_chart:
            try:                
                ...
                #self.tv_chart.maybe_export(df_chart, trade_journal.trades)
